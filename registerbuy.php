...
<form method="post" enctype="multipart/form-data" style="margin-left:50px; color:white; height:235px;"><br>
 
 <div class="form-group">
 <label>EMAIL_ID</label>
 <input class="form-control" type="email" name="em" width="300px;"> 
 </div>
