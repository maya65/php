...
<div class="row">
<div class="col-md-12" style="background-color:#2874f0;">		
<form action="careeraction_table.php" method="post" enctype="multipart/form-data" style="margin-left:50px; color:white; height:550px; margin-bottom:-10px;"><br>
<u><h2>career table</h2></u>
<div class="form-group">
<label>NAME</label>
<input class="form-control" type="text" id="tx" name="nm" style="width:350px;"> 
</div>

<div class="form-group">
 <label>MOBILE_NUMBER</label>
 <input class="form-control" type="number" name="mn"  style="width:350px;"> 
 </div>
 
 <div class="form-group">
 <label>EMAIL_ID</label>
 <input class="form-control" type="email" name="em" style="width:450px;"> 
 </div>
...
<center><input type="submit" value="Register" id="btn" style = "height:40px; color: #2874f0; background-color: #fff; margin-left:-90px; margin-top:10px; width:120px;">
</center>
</form>
</div>
...
<div class="clearfix"></div>
		<p class="copy-right">Â© 2023 Fashionist . All rights reserved </a></p></center>
