...
var b=document.getElementById("ty").value;
												...
												<div class="signin-form profile admin">
													...
													<div class="login-form">
														<form action="login_action.php" method="post">
															<input type="email" name="em" required="" id="tx">
															<input type="password" name="pass" required="" id="ty">
															<div class="tp">
																<input type="submit" value="LOGIN" onclick="return func()">
															</div>
