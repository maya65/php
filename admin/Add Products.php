															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">fill the details to submit </h3>
																	<div class="form-body">
																		...
																		<input type="text" name="pn" placeholder="Enter Product Name" id="np"> 
																		</div>
																		<div class="form-group"> 
																		<label>Price</label><br>
																		<input type="text" name="pr" placeholder="Enter Price">
																		</div> 
																		<div class="form-group"> 
																		<label>Offer_Price</label><br>
																		<input type="text" name="op" placeholder="Enter Offer Price">
																		</div>
																		<div class="form-group"> 
																		...
																		<input type="text" class="form-control" name="dp" placeholder="Enter Description">
																		</div>
																		<button type="submit" class="btn btn-default" onclick="return func()">Submit</button> 
																		</form> 
																	</div>
                                                             </div>
