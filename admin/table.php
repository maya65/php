...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<li class="second w3l_search">
					...
					<a href="export.php"><li class="active"><input type="submit" value="Export to Excel" id="export_data" name="export_data" style="margin-top:10px; width:120px; color:black;"></li></a>
					
				</li>
				<li class="second full-screen">
					<section class="full-top">
						<a href="pdf.php"><input type="submit" value="Export to pdf" id="export_data" name="export_data" style="margin-top:3px; width:120px; color:black;"></a>
					</section>
				</li>
		...
		<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <center><h3 class="w3_inner_tittle two">User Submitted Details</h3></center>
											...
											?>		
											  ...
											  <tr>
												...
												<td><a href="download.php?nama=<?php echo $row['RESUME'];?>"><?php echo $row['RESUME'];?></a></td>
												...
												{
													?>
												<button><a href="approve.php?approveid=<?php echo $row['id'];?>">Approve </a> </button>
												 <button> <a href="reject.php?rejectid=<?php echo $row['id'];?>"> Reject </a>   </button>
													</td> 
											  </tr>
