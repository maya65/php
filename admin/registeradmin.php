					  ...
					  <h2 class="w3_inner_tittle">Tables</h2>
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <center><h3 class="w3_inner_tittle two">User registered Details</h3></center>
											...
											<thead>
											  <tr>
												...
												<th>EMAIL_ID</th>
												<th>PASSWORD</th>
												<th>CONFRIM_PASSWORD</th>
												<th>SELECT_COUNTRIES</th>
												<th>SELECT_STATES</th>
											...
											$res=$con->query("select * from `registration` as A LEFT JOIN `countries` as P ON A.SELECT_COUNTRIES = P.cont_id LEFT JOIN `states` as N ON A.SELECT_STATES = N.stat_id");
											$count=$res->num_rows;
                                             if($count>0)
                                                  {								
