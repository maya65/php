							...
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									...
									<ul class="gn-submenu">
										...
										<li class="mini_list_w3"><a href="validation.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Forms Validation</a></li>
									</ul>
								</li>
								...
								<li class="page">
									<a href="#"><i class="fa fa-files-o" aria-hidden="true"></i> Pages <i class="fa fa-angle-right" aria-hidden="true"></i></a>
									  ...
									  <li class="mini_list_agile"> <a href="signin.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> Sign In</a></li>
									   ...
									   <li class="mini_list_agile"><a href="calender.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> Calender</a></li>
	
										<li class="mini_list_w3_line"><a href="404.php"> <i class="fa fa-caret-right" aria-hidden="true"></i>404 Error</a></li>
									</ul>
								</li>
								<li>
