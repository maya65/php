		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Charts</h2>
					     <!-- /charts_section_agileinfo-->
                          <div class="charts_section_agileinfo">
						     <div class="charts_agile_w3ls agile_info_shadow">
							     <h3 class="w3_inner_tittle two">Date Based Data</h3>
						...
						<!-- /chart_agile1-->
							<div class="chart_agile">
								 ...
								 <h3 class="w3_inner_tittle two">Donut chart</h3>
														<div id="chartdiv8"></div>
													  </div>

												<div class="col-md-6 top_chart agile_info_shadow">
														  <h3 class="w3_inner_tittle two">Simple Pie Chart</h3>
                        ...
                        <!-- /charts_section_agileinfo1-->
                          <div class="charts_section_agileinfo">
						     <div class="charts_agile_w3ls agile_info_shadow">
							     <h3 class="w3_inner_tittle two">Mixed daily and intra-day chart</h3>
						       <div id="chartdiv3"></div>
							 </div>
						  </div>
						<!-- //charts_section_agileinfo1-->
					   
						 <!-- /charts_section_agileinfo2-->
                          <div class="charts_section_agileinfo">
						     <div class="charts_agile_w3ls agile_info_shadow">
							     <h3 class="w3_inner_tittle two">Reversed Value Axis</h3>
						...
						<!-- /chart_agile-->
							<div class="chart_agile">
								 ...
								 <div class="clo-md-6 top_chart agile_info_shadow">
								 <h3 class="w3_inner_tittle two">Solid Gauge</h3>
														<div id="chartdiv5"></div>
													  </div>

														  <div class="col-md-6 top_chart agile_info_shadow">
														  <h3 class="w3_inner_tittle two">Radar Chart</h3>
