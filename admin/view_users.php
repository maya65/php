										 ...
										 <center><h3 class="w3_inner_tittle two">User Submitted Details</h3></center>
											...
											?>		
											  ...
											  <tr>
												...
												<td> <img src="<?php echo "pics/".$row['Choose_Image'];?>" style="width:150px; height:150px;"> </td> 
												<td> <?php echo $row['Description'];?> </td>
												<td> <a href="edit.php?editid=<?php echo $row['id'];?>">Edit </a> </td>
												<td> <a onclick="return confirm('Are you sure you want to delete this item?');"  href="delete.php?deleteid=<?php echo $row['id'];?>"> Delete </a> </td>
											  </tr>
											</tbody>
