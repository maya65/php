...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> Products <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
				            
										<li class="mini_list_w3"><a href="Add Products.php"><i class="fa fa-caret-right" aria-hidden="true"></i>Add Products</a></li>
										<li class="mini_list_w3"><a href="view_users.php"><i class="fa fa-caret-right" aria-hidden="true"></i> View Products</a></li>
								...
								<li><a href="table.php"> <i class="fa fa-table" aria-hidden="true"></i> View applied candidate</a></li>
				...
				<!-- //nav_agile_w3l -->
				     <li class="second logo"><h2><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i><?php echo $_SESSION['email'];?> </a></h2></li>
				       ...
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li name="logout_btn"> <a href="logout_action.php"><i class="fa fa-sign-out"></i> Logout</a> </li>
										</ul>
									</li>
				...
				<li class="second w3l_search">
					 ...
					 <a href="registeradmin.php"><li class="active"><input type="submit" value="Menu" style="margin-top:10px; width:60px; color:black;"></li></a>
				</li>
							  ...
							  <?php
										...
										<li>	
											...
											<div class="ca-content">
										       <h4 class="ca-main"><?php echo $row['total']; ?></h4>												   
...
<div class="copyrights">
	 <p>© 2023 Esteem. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>	
