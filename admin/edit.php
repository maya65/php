...
<div class="forms-main_agileits">
														 ...
														 <div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">fill the details to submit </h3>
																	<div class="form-body">
																		<form action="edit_test.php" method="post" enctype="multipart/form-data"> 
																		
																		<input class="form-control" type="hidden" name="tx" value="<?php echo $row['id'];?>" style="height:10px; width:90px;">
																		<div class="form-group"> 
																		<label>Product_name</label> <br>
																		<input type="text" name="pn"  value="<?php echo $row['Product_Name'];?>" placeholder="Enter Product Name" id="np"> 
																		</div>
																		<div class="form-group"> 
																		<label>Price</label><br>
																		<input type="text" name="pr"  value="<?php echo $row['Price'];?>" placeholder="Enter Price">
																		</div> 
																		<div class="form-group"> 
																		<label>Offer_Price</label><br>
																		<input type="text" name="op"  value="<?php echo $row['Offer_Price'];?>" placeholder="Enter Offer Price">
																		</div>
																		<div class="form-group"> 
																		<label>Choose_Image</label> 
																		<input type="file" name="pht"> <br>
																		 <img src="<?php echo "pics/".$row['Choose_Image'];?>" style="width:150px; height:150px;" class="form-control">
															
																		</div> 
																		<div class="form-group"> 
																		<label>Description</label><br>
																		<input type="text" class="form-control"  value="<?php echo $row['Description'];?>" name="dp" placeholder="Enter Description">
																		</div>
...
if(a=="")
{
alertify.alert("Please Enter The Product Name");
return false;
}
