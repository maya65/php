...
<head>
<title>Fashionist Online Shopping platform</title>
...
<div class="header-top">
	<div class="container">
		...
		<div class="col-md-6 phone-w3l">
			  ...
			  <li class="active"> <a href="view applied_candidates.php">Application details</a> </li>
			<ul>
...
<div class="col-md-4">
<br>
        <img src= "<?php echo "admin/pics/".$row['Choose_Image'];?>" width="250px" height="400px"> 
        <h4><?php echo $row['Product_Name']; ?></h4>
        <p>$<?php echo $row['Price']; ?></p>
		
		<h5><?php echo substr($row['Description'], 0 ,30); ?><a href="turtleneck2.php?editid=<?php echo $row['id'];?>">..Read More..</a><h5>
		<a href="buy.php?buyid=<?php echo $row['id'];?>"> <button class="btn btn-primary">continue to buy</button> </a>
...
<div class="footer">
	<div class="container">
		...
		<div class="clearfix"></div>
		<p class="copy-right">© 2023 Fashionist . All rights reserved | Design by Fashionist.</a></p>
	</div>
</div>
	<!-- cart-js -->
