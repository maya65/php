...
<div class="col-md-4">
<br>
        <img src= "<?php echo "admin/pics/".$row['Choose_Image'];?>" width="300" height="300"> 
        <h4><?php echo $row['Product_Name']; ?></h4>
        <p>$<?php echo $row['Price']; ?></p>
		
		<h5><?php echo substr($row['Description'], 0 ,30); ?><a href="turtle_neck.php?editid=<?php echo $row['id'];?>">..Read More..</a><h5>
