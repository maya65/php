...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2023 at 02:02 AM
...
INSERT INTO `admin` (`admin`, `EMAIL`, `PASSWORD`) VALUES
(1, 'maya@gmail.com', 12345);

-- --------------------------------------------------------

--
-- Table structure for table `agreegate_function`
--

CREATE TABLE `agreegate_function` (
  `id` int(22) NOT NULL,
  `S.NO` int(44) NOT NULL,
  `NAME` varchar(50) NOT NULL,
  `INCOME` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `agreegate_function`
--

INSERT INTO `agreegate_function` (`id`, `S.NO`, `NAME`, `INCOME`) VALUES
(1, 1, 'sam', '10,000'),
(2, 2, 'ram', '15,000'),
(3, 3, 'raj', '20,000');
...
CREATE TABLE `products` (
  ...
  `Offer_Price` int(50) NOT NULL,
  `Choose_Image` varchar(60) NOT NULL,
...
INSERT INTO `products` (`id`, `Product_Name`, `Price`, `Offer_Price`, `Choose_Image`, `Description`) VALUES
(77, 'turtle neck tshirt for men', 1200, 950, 'turtlenecks.jpg', 'Here are some ideas on layering it in with your F/W essentials.      WITH DENIM JACKET & MOLESKIN TOPCOAT. WITH PATTERNED SHIRT & CAMEL. WITH CHUNKY OUTER-CARDIGAN. WITH TAILORED SUIT & OVERCOAT. WITH TRIM CARDIGAN & TOPCOAT. WITH OXFORD SHIRT & FLANNEL SUIT. WITH BLAZER & JEANS. WITH BOMBER AND FLANNEL TROUSERS.'),
(87, 'formal shoes', 1000, 800, 'formal-shoes.jpg', 'Formal shoes are footwear worn with smart casuals at formal occasions such as weddings, office, or business meetings.'),
(90, 'sweatshirt', 600, 500, 'sweatshirt.jpg', 'It is a long-sleeved pullover shirt fashioned out of thick, usually cotton cloth material. Sweatshirts are almost exclusively casual attire and hence not as formal as some sweaters');
...
CREATE TABLE `registration` (
  ...
  `SELECT_COUNTRIES` int(50) NOT NULL,
  `SELECT_STATES` int(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `registration` (`id`, `NAME`, `MOBILE_NUMBER`, `EMAIL_ID`, `PASSWORD`, `CONFIRM_PASSWORD`, `SELECT_COUNTRIES`, `SELECT_STATES`) VALUES
(6, 'karthi', '9394093900', 'karthi@gmail.com', '3421', '3421', 101, 35),
(11, 'maya', '9859209391', 'maya@gmail.com', '12345', '12345', 101, 36),
(12, 'ram', '8594038030', 'ram@gmail.com', '123456', '123456', 101, 36),
(14, 'sam', '7865499011', 'sam1@gmail.com', '12567', '12567', 101, 35);
...
INSERT INTO `test` (`id`, `Name`, `Mobile_Number`, `Email_Id`, `Password`, `Image`, `Gender`) VALUES
(1, 'maya', '9089786786', 'maya@gmail.com', '123456', 'denim jean.jpg', '1'),
(12, 'sam', '122123431', 'sam1@gmail.com', '13423', 'printed shirt.jfif', '1'),
(13, 'sam', '757686987097', 'sam1@gmail.com', '1213243', 'gym tshirt.jpg', 'male');
...
INSERT INTO `user_id` (`id`, `NAME`, `MOBILE_NUMBER`, `EMAIL_ID`, `RESUME`, `user_id`, `STATUS`) VALUES
(2, 'ambedhkar', '9490392011', 'ambedhkar1@gmail.com', 'Marketing-Manager_Entry-level.pdf', '6', 2),
(3, 'sam', '9876432210', 'sam1@gmail.com', 'Marketing-Manager_Entry-level.pdf', '14', 0),
(4, 'parthipan', '7904908252', 'sam1@gmail.co', 'printed shirt.jfif', '11', 1),
(5, 'ambedhkar', '3456789098765432', 'ram23@gmail.co', '', '11', 2),
(9, 'raj', '9789678565', 'raj2@gmail.com', 'Marketing-Manager_Entry-level.pdf', '12', 0);
...
--
-- Indexes for table `agreegate_function`
--
ALTER TABLE `agreegate_function`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `agreegate_function`
--
ALTER TABLE `agreegate_function`
